...
const PROVIDERS: { id: Provider; name: string; icon: string; color: string; description: string; fields: { key: string; label: string; placeholder?: string; secret?: boolean }[] }[] = [
  ...
  { id: "r2",         name: "Cloudflare R2",         icon: "🔶", color: "from-[#F6821F] to-[#CF6B17]", description: "Zero egress fees, S3-compatible",
    fields: [{ key: "account_id", label: "Account ID", placeholder: "abc123..." }, { key: "access_key", label: "Access Key ID", placeholder: "xxx" }, { key: "secret_key", label: "Secret Access Key", secret: true, placeholder: "xxx" }, { key: "bucket", label: "Bucket Name", placeholder: "soltv-media" }, { key: "cdn_url", label: "Public URL / CDN", placeholder: "https://pub-xxx.r2.dev" }] },
